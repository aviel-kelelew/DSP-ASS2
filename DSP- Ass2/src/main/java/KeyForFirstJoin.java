...
public class KeyForFirstJoin implements WritableComparable<KeyForFirstJoin> {
    private String decade;
    private String word1;
    private String sign;

    public KeyForFirstJoin() {
        decade = "0";
        word1 = "";
        sign = "";
    }

    public KeyForFirstJoin(String decade, String word1, String sign) {
        this.decade = decade;
        this.word1 = word1;
        this.sign = sign;
    }
    ...
    @Override
    public int compareTo(KeyForFirstJoin other) {
