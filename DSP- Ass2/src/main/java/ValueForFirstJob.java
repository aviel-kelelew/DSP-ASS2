...
public class ValueForFirstJob implements WritableComparable<ValueForFirstJob> {
    private long numberWordInDecade;
    private long numerOfOcc;
    private long numOfOccOfW1W2;


    public ValueForFirstJob(){
        numberWordInDecade = -1;
        numerOfOcc = -1;
        numOfOccOfW1W2 = -1;
    }
    public ValueForFirstJob(long numberWordInDecade,long numerOfOcc){
      this.numberWordInDecade = numberWordInDecade;
      this.numerOfOcc = numerOfOcc;
      this.numOfOccOfW1W2 = 1;
    }

    public ValueForFirstJob(long numberWordInDecade, long numerOfOcc, long numOfOccOfW1W2){
        this.numberWordInDecade = numberWordInDecade;
        this.numerOfOcc = numerOfOcc;
        this.numOfOccOfW1W2 =numOfOccOfW1W2;
    }

    public ValueForFirstJob(long numOfOccOfW1W2){
    ...
    @Override
    public int compareTo(ValueForFirstJob other) {
        int ret = 0;
        long check= 0;
