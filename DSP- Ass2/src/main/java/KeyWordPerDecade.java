...
public class KeyWordPerDecade implements WritableComparable<KeyWordPerDecade> {
    private int decade;
    private String word1;  //we are using with big data . is int enough?  //count of w1w2
    private String word2;

    public KeyWordPerDecade(){
        decade = -1;
        word1 = "";
        word2 = "";
    }
    public KeyWordPerDecade(int year, String word1, String word2){
        this.decade = year/10;
        this.word1 = word1;
        this.word2 = word2;
    }
    @Override
    public int compareTo(KeyWordPerDecade other) {
